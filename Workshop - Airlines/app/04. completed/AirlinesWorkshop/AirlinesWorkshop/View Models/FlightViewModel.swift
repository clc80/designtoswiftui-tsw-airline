...
class FlightViewModel: ObservableObject {
    ...
    @Published var departureLocation = LocationItem.defaultDepartureLocation
    @Published var arrivalLocation = LocationItem.defaultArrivalLocation
    @Published var departureDate = DateItem.defaultDepartureDate
    @Published var arrivalDate = DateItem.defaultArrivalDate
    
    @Published var items: [LocationItem] = MockAirlinePreviewService.locationdata()
