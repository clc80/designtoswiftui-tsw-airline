...
struct CalendarSelectedItem: View {
    ...
    var body: some View {
        ...
        .matchedGeometryEffect(id: data.id, in: namespace, properties: .frame, isSource: false)
    }
}
...
struct CalendarSelectedItem_Previews: PreviewProvider {
    ...
    static var previews: some View {
        CalendarSelectedItem(data: DateItem("1", height: 100, month: "", displayDate: "21 June, 2020"), closeAction: {}, namespace: placeholder)
    }
}
